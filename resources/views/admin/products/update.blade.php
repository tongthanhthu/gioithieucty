...
@section('content')
    <div class="content">
        <form action="{{ route('admin.products.postUpdate',['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name_vi" value="{{ $product->name_vi }}" class="form-control">
                    </div>
                    @error('name_vi')
                            ...
                            <div class="portlet-body form album-images overlay_">
                                <div class="form-group param3 upload-ft">
                                    <div style="max-width: 1034px; margin: 0 auto; position: relative; padding-bottom: 69px;"
                                        ...
                                        <div class="ajax-upload-dragdrop pvm phl uiBoxWhite"
                                            ...
                                            <div class="ajax-file-upload"
                                                ...
                                                <div style="margin: 0px; padding: 0px;">
                                                    <input type="file" id="ajax-upload-id" name="file"
                                        ...
                                        <div class="ajax-file-upload-statusbar" data-item="order_799088" data-index="0" id="image_default">
                                            <div class="ajax-file-upload-filename" style="display: none;">
                                                {{ $product['image']['name'] }}</div>
                                            ...
                                            <div class="ajax-file-upload-file"><img alt="" src="{{asset('storage/'. $product['image']['path'])}}" width=""></div>
                                            <div class="ajax-file-upload-del" style="display: none;">
{{--                                                <div class="ajax-file-upload-del" style="display: none;">--}}
{{--                                                    <a href="{{ route('admin.images.delete', ['id' => $product['image']['id']]) }}"--}}
...
123 -304 440 -109 635 54 54 133 95 207 108 66 11 61 11 125 0z"/>
                                    ...
                                    <div style="max-width: 1034px; margin: 0 auto; position: relative; padding-bottom: 69px;"
                                        ...
                                        <div id="images-preview" style="min-width: 200px;display: flex;flex-wrap: wrap;">
                                            @foreach($product['images'] as $key => $image)
                                                <div class="ajax-file-upload-statusbar" data-item="order_799088" data-index="{{ $key }}">
                                                    <div class="ajax-file-upload-filename" style="display: none;">{{ $key++ }}.
                                                        {{ $image['name'] }}</div>
                                                    <div class="ajax-file-upload-progress" style="display: none;">
                                                        <div class="ajax-file-upload-bar ajax-file-upload-1697168821816" style="width: 100%;"></div>
                                                    </div>
                                                    <div class="ajax-file-upload-file"><img alt="" src="{{asset('storage/'. $image['path'])}}" width=""></div>
                                                    <div class="ajax-file-upload-del" style="display: none;">
                    ...
                    @php
                        $info_product_vi = (array) json_decode($product['info_product_vi']);
                        $info_product_en = (array) json_decode($product['info_product_en']);
                        $info_product_jp = (array) json_decode($product['info_product_jp']);
                        $info_product_kr = (array) json_decode($product['info_product_kr']);
                    @endphp
                    ...
                    <div id="input-container-vi">
                        ...
                        @if($info_product_vi)
                            @foreach($info_product_vi as $key => $value)
                                <div class="input-row-vi" style="margin: 5px 0">
                                    <input type="text" name="key_vi[]" value="{{ $key }}" placeholder="Nhập thuộc tính">
                                    <input type="text" name="value_vi[]" value="{{ $value }}" placeholder="Nhập giá trị">
                                    @if($key !== array_key_first($info_product_vi))
                                        <button type="button" style="border: none;background: none;" class="remove-input">
                                            <i class="bi bi-dash-circle"></i>
                                        </button>
                                    @endif
                                    <button type="button" style="border: none;background: none;display: none" class="remove-input">
                                        <i class="bi bi-dash-circle"></i>
                                    </button>
                                </div>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control custom-select">
                            @foreach ($categories as $item)
                                <option value="{{ $item->id }}" {{ $product->category_id == $item->id ? 'selected' : '' }}>{{ $item->name_vi }}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('category_id')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_vi" id="description_vi" class="form-control" rows="4">{{ $product->description_vi }}</textarea>
                    </div>
            ...
            <div class="card collapsed-card">
                ...
                <div class="card-body">
                    ...
                    <div id="input-container-en">
                        ...
                        @if($info_product_en)
                            @foreach($info_product_en as $key => $value)
                                <div class="input-row-en" style="margin: 5px 0">
                                    <input type="text" name="key_en[]" value="{{ $key }}" placeholder="Nhập thuộc tính">
                                    <input type="text" name="value_en[]" value="{{ $value }}" placeholder="Nhập giá trị">
                                    @if($key !== array_key_first($info_product_en))
                                        <button type="button" style="border: none;background: none;" class="remove-input">
                                            <i class="bi bi-dash-circle"></i>
                                        </button>
                                    @endif
                        ...
                        @else
                            <div class="input-row-en" style="margin: 5px 0">
                                <input type="text" name="key_en[]" value="" placeholder="Nhập thuộc tính">
                                <input type="text" name="value_en[]" value="" placeholder="Nhập giá trị">
                                <button type="button" style="border: none;background: none;display: none" class="remove-input">
                                    <i class="bi bi-dash-circle"></i>
                                </button>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="inputDescription">Mô tả chi tiết</label>
                        <textarea name="description_en" id="description_en" value="" class="form-control" rows="4">{{ $product->description_en }}</textarea>
                    </div>
            ...
            <div class="card collapsed-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">Tên sản phẩm</label>
                        <input type="text" name="name_jp" value="{{ $product->name_jp }}" class="form-control">
                    </div>
                    @error('name_jp')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <div id="input-container-jp">
                        ...
                        @if($info_product_jp)
                            @foreach($info_product_jp as $key => $value)
                                <div class="input-row-jp" style="margin: 5px 0">
                                    <input type="text" name="key_jp[]" value="{{ $key }}" placeholder="Nhập thuộc tính">
                                    <input type="text" name="value_jp[]" value="{{ $value }}" placeholder="Nhập giá trị">
                                    @if($key !== array_key_first($info_product_jp))
                                        <button type="button" style="border: none;background: none;" class="remove-input">
                                            <i class="bi bi-dash-circle"></i>
                                        </button>
                                    @endif
                        ...
                        @else
                            <div class="input-row-jp" style="margin: 5px 0">
                                <input type="text" name="key_jp[]" value="" placeholder="Nhập thuộc tính">
                                <input type="text" name="value_jp[]" value="" placeholder="Nhập giá trị">
                                <button type="button" style="border: none;background: none;display: none" class="remove-input">
                                    <i class="bi bi-dash-circle"></i>
                                </button>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="inputDescription">Mô tả chi tiết</label>
                        <textarea name="description_jp" id="description_jp" value="" class="form-control" rows="4">{{ $product->description_jp }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card collapsed-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">Tên sản phẩm</label>
                        <input type="text" name="name_kr" value="{{ $product->name_kr }}" class="form-control">
                    </div>
                    @error('name_kr')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <div id="input-container-kr">
                        ...
                        @if($info_product_kr)
                            @foreach($info_product_kr as $key => $value)
                                <div class="input-row-kr" style="margin: 5px 0">
                                    <input type="text" name="key_kr[]" value="{{ $key }}" placeholder="Nhập thuộc tính">
                                    <input type="text" name="value_kr[]" value="{{ $value }}" placeholder="Nhập giá trị">
                                    @if($key !== array_key_first($info_product_kr))
                                        <button type="button" style="border: none;background: none;" class="remove-input">
                                            <i class="bi bi-dash-circle"></i>
                                        </button>
                                    @endif
                        ...
                        @else
                            <div class="input-row-kr" style="margin: 5px 0">
                                <input type="text" name="key_kr[]" value="" placeholder="Nhập thuộc tính">
                                <input type="text" name="value_kr[]" value="" placeholder="Nhập giá trị">
                                <button type="button" style="border: none;background: none;display: none" class="remove-input">
                                    <i class="bi bi-dash-circle"></i>
                                </button>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="inputDescription">Mô tả chi tiết</label>
                        <textarea name="description_kr" id="description_kr" value="" class="form-control" rows="4">{{ $product->description_kr }}</textarea>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function uploadImage(file, className) {
            ...
            const imageDefaultDiv = document.getElementById("image_default");
            if (className === 'image-preview') {
                imageDefaultDiv.style.display = "none";
                imagePreview.innerHTML = ''; // Xóa các ảnh trước đó
            }
        ...
        document.querySelector('input[name="file"]').addEventListener('change', async function (event) {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    const imageDefaultDiv = document.getElementById("image_default");
                    imageDefaultDiv.style.display = "block";
