...
<div style="padding:20px">
    ...
    <p style="padding:1px 0px 15px 0px;margin:0px">Quý khách có 1 yêu cầu ứng tuyển mới.</p>
    <table width="100%" cellpadding="5" cellspacing="0" border="0" style="color:#6d6d6d">
        ...
        <tr>
            ...
            <td style="border-top:1px solid #dceff5;color:#494949">{{ $request['name'] }}</td>
        </tr>
        <tr>
            <td style="border-top:1px solid #dceff5"><b>•&nbsp;Số điện thoại</b></td>
            <td style="border-top:1px solid #dceff5"><b style="color:#f53030">{{ $request['phone'] }}</b></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border-top:1px solid #dceff5;color:#494949">{{ $request['contents_description'] }}</td>
        </tr>
        </tbody>
    </table>
</div>
