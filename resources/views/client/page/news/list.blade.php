...
@section('content')
        ...
        <div class="bota_breadcrumb_banner">
            <div class="bota_breadcrumb_banner_el">
                <div class="bota_breadcrumb_title">
                    <h1>{!! __('message.news_search_results') !!}</h1>
                </div>
    ...
    <div class="bota_news_page">
        <div class="container">
            <span>{!! __('message.keyword_search_results') !!} : "{{$keyword}}"</span>
            <div class="row">
            ...
            @else
                <div class="col-xl-8 col-lg-8 col-sm-12">
                    <div class="bota_news_default_list">
                        <span>{!! __('message.there_are_no_results_for_the_keyword') !!} : "{{$keyword}}"</span>
                    </div>
                </div>
            @endif
